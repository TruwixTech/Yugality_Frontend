...
export default function AIAssistantPage() {
  ...
  // FOR TO FETCH THE EXISTING CHATS
  ...
  return (
    <div className="flex h-screen relative bg-colorlight">
      {sidebarOpen && (
        <div
          className="fixed inset-0 bg-colordark/50 z-40 lg:hidden backdrop-blur-sm transition-all"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="lg:hidden flex items-center justify-between p-4 bg-white/80 backdrop-blur-md border-b border-colordark/6">
          <button
            ...
            className="p-2 text-colordark/60 hover:text-colordark hover:bg-colordark/[0.04] rounded-xl transition-all"
          >
            <Menu size={20} strokeWidth={2} />
          </button>
          <span className="text-[0.875rem] font-bold text-colordark tracking-tight">
            AI Assistant
          </span>
        ...
        {fetchingChat ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-[0.75rem] font-bold text-colordark/20 uppercase tracking-[0.2em]">
